...
$config['stylesheet_compiler']['settings']['primary'] = array('type' => 'color', 'default' => '#86BC42', 'label' => 'Primary color');
...
// Member menu icon
$config['stylesheet_compiler']['settings']['headerIconColor'] = array('type' => 'color', 'default' => '#fff', 'label' => 'Header icon color');
$config['stylesheet_compiler']['settings']['headerIconLabelColor'] = array('type' => 'color', 'default' => '#fff', 'label' => 'Header icons label color');
...
$config['stylesheet_compiler']['settings']['usermenuColor'] = array('type' => 'color', 'default' => '#000', 'label' => 'User Menu Color');
$config['stylesheet_compiler']['settings']['usermenuHoverBg'] = array('type' => 'color', 'default' => '#000', 'label' => 'User Menu Hover Background');
$config['stylesheet_compiler']['settings']['usermenuHoverColor'] = array('type' => 'color', 'default' => '#fff', 'label' => 'User Menu Hover Color');
...
$config['stylesheet_compiler']['settings']['footerMenuColor'] = array('type' => 'color', 'default' => '#fff', 'label' => 'Footer Menu Color');
...
$config['stylesheet_compiler']['settings']['categoryFontHoverColor'] = array('type' => 'color', 'default' => '#86bc42', 'label' => 'Hover And Active Color');
...
$config['stylesheet_compiler']['settings']['searchButtonColor'] = array('type' => 'color', 'default' => '#41544A', 'label' => 'Search Button Color');
...
$config['stylesheet_compiler']['settings']['blogLinksColor'] = array('type' => 'color', 'default' => '#0044de', 'label' => 'Link Color');
$config['stylesheet_compiler']['settings'][] = array('type' => 'delimiter');
