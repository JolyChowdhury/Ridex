...
<style>
    ...
    #header-menu ul.list.slick-slider-custom.slick-slider li li:hover>ul {
        left: 100%;
        top: 0;
    }
    ...
    #header-menu ul.list.slick-slider-custom.slick-slider {
        max-width: 660px;
        z-index: 99;
    }
    #header-menu ul.list.slick-slider-custom.slick-slider button.slick-arrow {
        margin-top: 2px;
    }

    #header-menu ul.list.slick-slider-custom.slick-slider button.slick-arrow::before {
        color: #fff !important;
        opacity: 1;
    }
    #header-menu ul.list.slick-slider-custom.slick-slider li:hover>ul {
        display: block;
    }
