...
<?php
    ...
    $dataSet = $controller->index($params, 'col-4');
...
<?php if (!empty($data) && !isset($_GET['slug']) && !isset($_GET['wishlist_id'])):
    ...
    ?>
        ...
        <?php foreach ($data as $item):
            ...
            <div class="col-lg-3 col-md-6 item-<?php print $item['content_id'] ?>">
...
<?php if (isset($pages_count) and $pages_count > 1 and isset($paging_param) and $hide_paging && !isset($_GET['slug']) && !isset($_GET['wishlist_id'])): ?>
